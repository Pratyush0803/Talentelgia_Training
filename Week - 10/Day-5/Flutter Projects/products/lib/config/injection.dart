...
import '../features/add_products/domain/use_cases/delete_product_use_case.dart';
import '../features/add_products/domain/use_cases/edit_product_use_case.dart';
...
import '../features/manage_category/data/models/manage_category_model.dart';
import '../features/manage_category/data/repositories/manage_category_repository_impl.dart';
import '../features/manage_category/domain/entity/manage_category_entity.dart';
...
Future<void> configureDependencies() async {
  ...
  getIt.registerLazySingleton<EditProductUseCase>(
        () => EditProductUseCase(getIt<AddProductRepository>()),
  );
  getIt.registerLazySingleton<DeleteProductUseCase>(
        () => DeleteProductUseCase(getIt<AddProductRepository>()),
  );
